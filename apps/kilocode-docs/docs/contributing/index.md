...
Before diving into the code, we recommend reviewing the [Architecture Overview](/contributing/architecture/architecture) to understand how the different components of Kilo Code fit together.
